/* COMMENTS:
  ...
  This script picks 100 tables, in a distribution of: the top 20 tables with pups, top 30 dmd non pups, 
  top 12 SS alphanumerics, top 17 SS, top 8 EM, and top 13 Original (non-vendor) tables. 
*/
SELECT * FROM (
    SELECT * FROM (
        SELECT * FROM Games
